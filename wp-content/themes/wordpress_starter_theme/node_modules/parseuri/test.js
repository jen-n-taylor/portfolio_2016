...
describe('my suite', function(){
    ...
    var http = parseuri('http://google.com')
      ...
      , jentaylorcodes.com = parseuri('jentaylorcodes.com:8080')
    ...
    expect(jentaylorcodes.com.protocol).to.be('');
    expect(jentaylorcodes.com.host).to.be('jentaylorcodes.com');
    expect(jentaylorcodes.com.port).to.be('8080');
