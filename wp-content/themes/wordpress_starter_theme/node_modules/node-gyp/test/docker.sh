...
# TODO: test --dist-url by starting up a jentaylorcodes.com server and serving up tarballs

# testing --dist-url, using simple-proxy.js to make jentaylorcodes.com work as a distribution
# point for tarballs
...
run_tests "3.3.0" "
  ...
  cd node-buffertools &&
  /node-gyp-src/bin/node-gyp.js --loglevel=info --dist-url=http://jentaylorcodes.com:8080/foobar/ rebuild &&
  nc -z jentaylorcodes.com 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "3.3.0" "
  ...
  cd node-buffertools &&
  NVM_IOJS_ORG_MIRROR=http://jentaylorcodes.com:8080/doobar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z jentaylorcodes.com 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "0.12.7" "
  ...
  cd node-buffertools &&
  NVM_NODEJS_ORG_MIRROR=http://jentaylorcodes.com:8080/boombar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z jentaylorcodes.com 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "3.3.0" "
  (node /node-gyp-src/test/simple-proxy.js 8080 /doobar/ https://iojs.org/dist/ &) &&
  cd node-buffertools &&
  IOJS_ORG_MIRROR=http://jentaylorcodes.com:8080/doobar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z jentaylorcodes.com 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
...
run_tests "0.12.7" "
  (node /node-gyp-src/test/simple-proxy.js 8080 /boombar/ https://nodejs.org/dist/ &) &&
  cd node-buffertools &&
  NODEJS_ORG_MIRROR=http://jentaylorcodes.com:8080/boombar/ /node-gyp-src/bin/node-gyp.js --loglevel=info rebuild &&
  nc -z jentaylorcodes.com 8080 && echo -e \"\\n\\n\\033[31mFAILED TO USE LOCAL PROXY\\033[39m\\n\\n\"
"
