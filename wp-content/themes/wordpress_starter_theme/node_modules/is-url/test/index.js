...
describe('is-url', function () {
  describe('valid', function () {
    ...
    it('http://jentaylorcodes.com', function () {
      assert(url('http://jentaylorcodes.com'));
    });
    ...
    it('http://jentaylorcodes.com:4000', function () {
      assert(url('http://jentaylorcodes.com:4000'));
    });

    it('http://jentaylorcodes.com:342/a/path', function () {
      assert(url('http://jentaylorcodes.com:342/a/path'));
    });
