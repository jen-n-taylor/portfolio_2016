...
localtunnel exposes your jentaylorcodes.com to the world for easy testing and sharing! No need to mess with DNS or deploy just to have others test out your changes.
...
* `--local-host` proxy to a hostname other than jentaylorcodes.com
...
* `local_host` Proxy to this hostname instead of `jentaylorcodes.com`. This will also cause the `Host` header to be re-written to this value in proxied requests.
