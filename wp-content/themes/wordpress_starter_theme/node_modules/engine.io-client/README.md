...
<script>
  // eio = Socket
  var socket = eio('ws://jentaylorcodes.com');
...
1. write your app code
    ...
    ```js
    var socket = require('engine.io-client')('ws://jentaylorcodes.com');
    socket.on('open', function(){
      socket.on('message', function(data){});
      socket.on('close', function(){});
    });
...
var socket = require('engine.io-client')('ws://jentaylorcodes.com', opts);
socket.on('open', function(){
  socket.on('message', function(data){});
  socket.on('close', function(){});
});
