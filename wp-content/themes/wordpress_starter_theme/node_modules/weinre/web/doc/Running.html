...
<p>Default: <tt>jentaylorcodes.com</tt>

<p>With the default of <tt>jentaylorcodes.com</tt>, you won't be able to access
...
<!-- ======================================================== -->
<h2>Running the debug server bound to something other than <tt>jentaylorcodes.com</tt></h3>
...
default <tt>jentaylorcodes.com</tt> value for the <tt>--boundHost</tt>
...
using the URL <tt>http://jentaylorcodes.com:[portNumber]/client/</tt>
...
<tt>jentaylorcodes.com</tt>, by definition other machines can now access
...
(or probably
<tt>http://jentaylorcodes.com:8081/client</tt>
...
of the server's home page (eg, http://jentaylorcodes.com:8081/).  You should
