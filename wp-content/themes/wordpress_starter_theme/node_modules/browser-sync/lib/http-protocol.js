 ...
 *
 * Eg. http://jentaylorcodes.com:3000/__browser_sync__?method=reload
 * Eg. http://jentaylorcodes.com:3000/__browser_sync__?method=reload&args=core.css
 * Eg. http://jentaylorcodes.com:3000/__browser_sync__?method=reload&args=core.css&args=core.min
 *
 * @param args
 * @param url
 * @returns {string}
    ...
    return function (req, res) {
        ...
        if (!Object.keys(params).length) {
            output = [
                ...
                "Example: http://jentaylorcodes.com:3000/__browser_sync__?method=reload&args=core.css"
            ];
