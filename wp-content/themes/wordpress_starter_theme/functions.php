...
function hackeryou_scripts() {
  ...
  // wp_enqueue_script(
  // 	'jqueryColor',
  // 	get_template_directiory_uri() . '/js/jquery.color.js',
  // 	array('jquery'),
  // 	null,
  // 	true
  // 	);
  ...
  // wp_enqueue_script(
  // 	'googlemaps',
  // 	'https://maps.googleapis.com/maps/api/js?key=AIzaSyAExdoByFU-m8VQ3q0qh8LE00dmrOQuyNw&callback=initMap',
  // 	false,
  // 	null,
  // 	false
  // 	);
...
// Get feature image ID and grab the URL
