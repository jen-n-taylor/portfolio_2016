...
# bash tests/bin/install-wp-tests.sh wordpress_test root '' jentaylorcodes.com latest
...
install_test_suite() {
	...
	sed $ioption "s|jentaylorcodes.com|${DB_HOST}|" wp-tests-config.php
}
